...
class Transformer(object):
    ...
    def __init__(self, config, ):
        ...
        # 定义模型的输入
        self.inputX = tf.placeholder(tf.int32, [config.batch_size, config.max_seqlen], name="inputX")
        self.inputY = tf.placeholder(tf.int32, [config.batch_size, config.max_seqlen], name="inputY")
        print('shape inputx', np.shape(self.inputX))
    ...
    def _positionEmbedding(self, scope="positionEmbedding"):
        ...
        embeddingSize = self.config.embed_size
    ...
    def train_epoch(self,
        ...
        for epoch in range(self.max_epochs):
            ...
            for step in shuf_step:
                ...
                print(' train epoch input\n\n',self.batch_size,np.shape(input_batch))
                feed = {
                    self.inputX: input_batch,
                    self.inputY: label_batch,
                    self.dropoutKeepProb: self.config.model.dropoutKeepProb,
