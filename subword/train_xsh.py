...
class Config(object):
    def __init__(self):
        ...
        self.max_seqlen = 20
        self.base_datadir = "../"
        self.original_file = self.base_datadir+'data/input_word_label.txt'
        self.train_file = self.base_datadir+'data/train.txt'
        self.dev_file = self.base_datadir+'data/dev.txt'
        self.vocab_file = self.base_datadir+'data/vocab.txt'
